...
- **id** - `string`: the tweet ID. For example in `https://twitter.com/chibicode/status/2040511285998313827` the tweet ID is `2040511285998313827`. This is the only required prop.
