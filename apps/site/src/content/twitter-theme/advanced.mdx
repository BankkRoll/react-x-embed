  ...
  return (
    <TweetContainer>
      ...
      {tweet.mediaDetails?.length ? (
        ...
        // A tweet's own media takes precedence over a link preview, matching X.
        // Drop this and tweets sharing a link render without their card.
...
import { type TweetProps, TweetNotFound, TweetSkeleton } from 'react-x-embed'
